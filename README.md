# Тестовое задание для компании Berners team

> Используется Gulp 4

## Демо

https://sanyokstd.github.io/Berners-test1/app/

## Начало работы

Для работы с данной сборкой в новом проекте, склонируйте все содержимое репозитория <br>
`git clone <this repo>`
Затем, находясь в корне проекта, запустите команду `npm install` или `yarn install`, которая установит все находящиеся в package.json зависимости.
